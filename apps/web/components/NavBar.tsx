...
export default function NavBar({
  ...
  return (
    <div className='flex flex-col'>
      <div className='fixed top-0 z-40 hidden h-16 w-full items-center px-8 backdrop-blur-md transition-colors duration-500 md:flex'>
        <NavigationMenu>
          <NavigationMenuList>
            ...
            {userOrg && (
              <NavigationMenuItem>
                <Link href={`/dashboard/${userOrg}`} legacyBehavior passHref>
                  <NavigationMenuLink className={navigationMenuTriggerStyle()}>
                    <div className='flex flex-row items-center gap-2 rounded-full bg-foreground px-4 py-2 text-background hover:bg-foreground/80'>
                      Dashboard
