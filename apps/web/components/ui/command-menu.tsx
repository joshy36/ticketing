...
export function CommandMenu({ ...props }: DialogProps) {
  ...
  return (
    <div className=''>
      <Button
        className={cn(
          'relative w-full justify-start border bg-zinc-950/50 text-sm text-muted-foreground shadow-none hover:bg-transparent hover:bg-zinc-950 sm:pr-12 md:w-40 lg:w-64',
        )}
