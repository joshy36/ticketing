        ...
        <ScrollView>
          <View className='pb-24'>
            <View className='flex flex-row justify-end pr-2'>
              <TouchableOpacity
                className='w-24 rounded-full border border-gray-800 bg-black py-3'
                onPress={() => signOut()}
              >
              ...
              <View className='pb-6'>
                <View className='flex flex-row'>
                  {userProfile?.first_name && (
                    <Text className='text-2xl font-bold text-white'>{`${userProfile.first_name} `}</Text>
                  )}
                  {userProfile?.last_name && (
                    <Text className='text-2xl font-bold text-white'>{`${userProfile.last_name}`}</Text>
                  )}
                </View>
